...
public static class RandomNumber
{
    ...
    public static Vector2f VectorAndReflect(int min, int max)
    {
        return VectorAndReflect(min, max, min, max);
    }
    ...
    public static Vector2f Vector(int min, int max)
    {
        return Vector(min, max, min, max);
    }
