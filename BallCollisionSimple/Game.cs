...
{
    private Ball _b1 = new();
    private Ball _b2 = new();
    private CircleShape _shape = new();
    private FloatLine _line = new();
    private bool _dragging = false;

    public FloatCircle C1 => new(_b1.Position, _b1.Radius);
    public FloatCircle C2 => new(_b2.Position, _b2.Radius);
